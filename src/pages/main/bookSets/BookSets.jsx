...
const BookSets = () => {
	return (
		<div className={css.bookSets}>
			<div className={css.bookSetsItem1}>
				<img
			...
			<div className={css.bookSetsItem2}>
				<img
					className={css.setFoto}
				...
				<div className={`${css.setDesc} ${css.right}`}>
					<h3 className={`${css.setHeader} ${css.right}`}>Шримад<br />Бхагаватам</h3>
					...
					<div className={`${css.setBtnBlock} ${css.rev}`}>
						<div className={`${css.setBtnLink} ${css.btnRight}`}>Подробнее</div>
